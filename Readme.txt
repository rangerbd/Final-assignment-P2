...
2. Rename the Entity to country.
3. drop year except 2000,2005,2010,2015,2018.
4. drop the countries that don’t match with death csv datasets.

Drop the countries that has no match from alcho_consumption

5.drop all the death columns except alcohol related death
